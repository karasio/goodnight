...
public class TipsList {
    ...
    private TipsList() {
        ...
        tips.add(new Tip("INCREASE SLEEP QUALITY","Go to bed only when you're tired. If you can't fall asleep in 15 minutes, get up for a while. Get up at the same time every morning. Don't take naps."));
    }
